...
var AuthResolverImport = utils_1.printedGenTypingImport({
    module: 'nexus-auth-plugin',
    bindings: ['AuthResolver'],
});
var fieldDefTypes = utils_1.printedGenTyping({
    optional: true,
    name: 'withAuth',
    type: "AuthResolver<TypeName, FieldName> | boolean",
    imports: [AuthResolverImport],
});
exports.authPlugin = function (_a) {
    var defaultAuthorize = _a.defaultAuthorize;
    return nexus_1.plugin({
        name: 'AuthPlugin',
        fieldDefTypes: fieldDefTypes,
        onCreateFieldResolver: function (config) {
            return function (root, args, ctx, info, next) { return __awaiter(void 0, void 0, void 0, function () {
                var withAuth, isValid;
                var _a, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            withAuth = (_b = (_a = config.fieldConfig.extensions) === null || _a === void 0 ? void 0 : _a.nexus) === null || _b === void 0 ? void 0 : _b.config.withAuth;
                            isValid = true;
                            if (!withAuth) {
